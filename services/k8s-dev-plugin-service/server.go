...
func (plugin *DevicePlugin) GetPreferredAllocation(ctx context2.Context, request *pluginapi.PreferredAllocationRequest) (*pluginapi.PreferredAllocationResponse, error) {
